...
# input layer 28*28 followed by the output layer 10 classes
# stochastic gradient descent is used for updating the weights
...
print('Test accuracy: {}'.format(correct*100 / total))
